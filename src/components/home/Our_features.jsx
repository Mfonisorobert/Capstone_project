  ...
  return (
    <div className='feat__container'>
      ...
      <h3>Health Reminder</h3>
        ...
        <h5>Never miss a step in your wellness journey with our health reminder feature. Stay on track with timely notifications for medication, workouts, hydration, and more. Your personalized health assistant, always keeping you one step ahead.</h5>
        <a href="https://demo.olivethemes.com/exo/2022/08/22/professionals-team-management-ideas/" target="_blank" rel="noopener noreferrer">
      <h2>Start Now <i class="fas fa-angle-right styled_icon"></i></h2>  
      </a>
      ...
      <h3>Offline Access</h3>
        ...
        <h5>Stay connected to your health, even without the internet. With our offline access feature, you can view and update your health data anytime, anywhere. Your progress is saved and synced seamlessly once you're back online.</h5>
        <a href="https://demo.olivethemes.com/exo/2022/08/22/professionals-team-management-ideas/" target="_blank" rel="noopener noreferrer">
      <h2>Start Now <i class="fas fa-angle-right styled_icon"></i></h2>  
      </a>
